...
const WhoWeAre: React.FC = () => {
  return (
    <div className='flex items-center justify-center'>
      <div className={`flex flex-col md:flex-row items-center justify-between py-12 bg-white ${PAGE_WIDTH_CONFIG} items-center justify-center`}>
        {/* Text Section */}
        <div className="md:w-1/2">
          <h2 className="text-3xl font-bold mb-4 font-alike">Who We Are</h2>
          <p className="text-gray-600 mb-4 font-alice text-justify">
          ...
          <p className="text-gray-600 font-alice text-justify">
