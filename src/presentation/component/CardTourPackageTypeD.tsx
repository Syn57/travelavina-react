...
const CardTourPackageTypeD = ({
    ...
    return (
        <div className={`relative ${gridHeightValueConverter(layoutConfigs.height)}`}>
            ...
            <a href={`${card.route}`} 
                className="absolute z-20 mt-4 px-4 py-2 bg-white bg-opacity-70 rounded-md text-black font-alice text-sm hover:bg-opacity-90 right-0 bottom-0 mb-4 mx-3 text-center transition"
            >Learn More</a>
            <img
                src={card.image}
...
export default CardTourPackageTypeD;