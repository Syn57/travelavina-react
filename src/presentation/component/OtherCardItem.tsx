...
const OtherCardItem = ({card} : {card: LainnyaCardDomain}) => {
    return (
      <div className="rounded-lg shadow-lg overflow-hidden border border-ternary">
        {/* Image Section */}
        ...
        <div className="p-4 flex flex-col">
            ...
            <a href={card.route}
                className={`w-1/2 px-4 pb-3 pt-2 bg-secondary hover:bg-orange-600 rounded-lg text-white font-medium flex items-center text-sm font-alike justify-center self-end`}>
        ...
        {/* Footer Section */}
        <div className="bg-ternary p-4 flex justify-around items-center">
